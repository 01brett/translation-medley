...
export const fetchVerse = (bible, location) => dispatch => {
  dispatch({ type: FETCH_VERSE_START });
  axios
    .get(`https://api.biblia.com/v1/bible/content/${bible}.json?passage=${location}&style=oneVersePerLine&key=fd37d8f28e95d3be8cb4fbc37e15e18e`)
    .then(res => {
